...
The following applies to code changes to the Hanacoin Core project, and is not to be confused with overall Hanacoin
...
Copyright
---------
Copyright 2018 The Hanacoin Core Developers
