...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000004017cf760e00000");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-dnsseed.hanacoin.org");
