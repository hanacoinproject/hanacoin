Hanacoin Core version 0.14.2 is now available from:
  ...
  <https://download.hanacoin.org/hanacoin-0.14.2.0/>
...
Hanacoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
- http://testnet.hanacointools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/hanacoinproject/hanacoin/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/hanacoinproject/hanacoin/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in Hanacoin Core 0.10.4 and removed in 0.13.2. 
