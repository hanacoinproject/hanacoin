# Support for Output Descriptors in Hanacoin Core

Since Hanacoin Core v0.17, there is support for Output Descriptors in the
...
on Hanacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Hanacoin Core wallets, a convenience function `combo` is
