...
"""Verify that starting hanacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hanacoin with -h for help text")
        ...
        self.log.info("Start hanacoin with -version for version information")
        ...
        self.log.info("Start hanacoind with -fakearg to make sure it does not start")
